...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//<< УИТ На форме добавлен элемент ДатаНачальнойЗагрузки
 	Элемент = ЭтаФорма.Элементы.Добавить("ДатаНачальнойЗагрузки", Тип("ПолеФормы"), Элементы.ПолучениеПисем); 
    Элемент.Вид = ВидПоляФормы.ПолеВвода; 
	Элемент.ПутьКДанным = "Объект.ДатаНачальнойЗагрузки";
	Если Объект.Ссылка.Пустая() Тогда
		Объект.ДатаНачальнойЗагрузки = ТекущаяДатаСеанса();
	КонецЕсли;
	//>>
