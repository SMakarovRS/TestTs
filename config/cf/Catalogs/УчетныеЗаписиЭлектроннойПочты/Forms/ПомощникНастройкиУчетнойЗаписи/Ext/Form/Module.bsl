...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//<< УИТ На форме добавлен элемент ДатаНачальнойЗагрузки. Добавить его надо так же в реквизиты.
 	Элемент = ЭтаФорма.Элементы.Добавить("ДатаНачальнойЗагрузки", Тип("ПолеФормы"), Элементы.НастройкаУчетнойЗаписи); 
    Элемент.Вид = ВидПоляФормы.ПолеВвода; 
	Элемент.ПутьКДанным = "ДатаНачальнойЗагрузки";
	ДатаНачальнойЗагрузки = НачалоМесяца(ТекущаяДатаСеанса());
	//>>
...
Процедура СоздатьУчетнуюЗапись()
	...
	Попытка
		...
		КонецЕсли;
		//<< УИТ Для созданной учетной записи устанавливаем дату начальной загрузки
		УчетнаяЗапись.ДатаНачальнойЗагрузки = ДатаНачальнойЗагрузки;
		//>>
