...
Процедура ПользовательПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Пользователь) Тогда
		...
		МобильныеКлиенты = ОбменМобильноеПриложениеВызовСервера.ПолучитьУзлыОбменаПоВладельцу(Пользователь);
...
Процедура ОчиститьПереданныеСообщенияПродолжение(Ответ, Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(МобильныйКлиент) Тогда
		ОбменМобильноеПриложениеВызовСервера.УдалениеСообщенийОбменаМобильноеПриложениеПоКлиенту(МобильныйКлиент);
	Иначе
		ОбменМобильноеПриложениеВызовСервера.УдалениеСообщенийОбменаМобильноеПриложениеПоКлиенту();
	КонецЕсли;
	
	ОповеститьОбИзменении(Тип("СправочникСсылка.СообщенияОбменаМобильноеПриложение"));	
