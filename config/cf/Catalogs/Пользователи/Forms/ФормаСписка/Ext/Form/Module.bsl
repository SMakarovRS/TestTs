...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//<< УИТ Добавлен запрет выбора недействительных пользователей в качестве исполнителей задания
	Если Параметры.Свойство("ПоказыватьНедействительных") Тогда 
		Элементы.ПоказыватьНедействительныхПользователей.Видимость = Параметры.ПоказыватьНедействительных;
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
