...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант.Описание = НСтр("ru = 'Информация по взаиморасчетам с контрагентами'");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ПоДокументам");
	Вариант.Описание = НСтр("ru = 'Информация по взаиморасчетам с контрагентами с детализацией по документам'");
