...
Процедура ПриОткрытии(Отказ)
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиДлительность, 
		1, ВладелецФормы.НомерКолонкиДлительность).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиНачало, 
		1, ВладелецФормы.НомерКолонкиНачало).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиОкончание, 
		1, ВладелецФормы.НомерКолонкиОкончание).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиПроцентЗавершения, 
		1, ВладелецФормы.НомерКолонкиПроцентЗавершения).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиНачалоФакт, 
		1, ВладелецФормы.НомерКолонкиНачалоФакт).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиОкончаниеФакт, 
		1, ВладелецФормы.НомерКолонкиОкончаниеФакт).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиРесурсыПредставление, 
		1, ВладелецФормы.НомерКолонкиРесурсыПредставление).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиЗатраты,
		1, ВладелецФормы.НомерКолонкиЗатраты).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиДопЗатраты,
		1, ВладелецФормы.НомерКолонкиДопЗатраты).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиСтоимость,
		1, ВладелецФормы.НомерКолонкиСтоимость).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиДопСтоимость,
		1, ВладелецФормы.НомерКолонкиДопСтоимость).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиЗатратыФакт,
		1, ВладелецФормы.НомерКолонкиЗатратыФакт).Видимость;
	...
	НоваяСтрока.Пометка = тдПроект.Область(1, ВладелецФормы.НомерКолонкиСтоимостьФакт,
		1, ВладелецФормы.НомерКолонкиСтоимостьФакт).Видимость;
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыКолонок
