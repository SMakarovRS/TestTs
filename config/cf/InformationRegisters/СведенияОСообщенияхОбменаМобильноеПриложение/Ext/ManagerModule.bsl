...
// Записывает сведения о сообщении обмена с мобильным приложением.
// Параметры:
//	Сообщение - ссылка на СообщенияОбменаМобильноеПриложение;
...
Процедура ЗаписатьСведения(Сообщение, РазмерСообщения, КоличествоДанных) Экспорт
	...
	Запись = РегистрыСведений.СведенияОСообщенияхОбменаМобильноеПриложение.СоздатьМенеджерЗаписи();
...
// Записывает время формирования сообщения обмена с мобильным приложением.
...
// Записывает время подготовки сообщения обмена с мобильным приложением.
