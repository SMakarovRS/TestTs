...
&НаКлиенте
Перем ИдентификаторЗамераОткрытия;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Устанавливаем отбор, если открытие было из импорта данных из сторонних программ.
	Если Параметры.Свойство("ОтборПоДокументам") Тогда
		
		КонтекстноеОткрытие = Истина;
		РаботаСОтборамиКлиентСервер.УстановитьЭлементОтбораСписка(Список, "Ссылка", Параметры.ОтборПоДокументам);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Поступление_ФормаСписка_УстановленОтборПериод" Тогда	
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	// СтандартныеПодсистемы.ОценкаПроизводительности
	КлючеваяОперация = "ДокументПоступление (открытие)";
...
Процедура ПредставлениеПериодаНажатие(Элемент, СтандартнаяОбработка)
	...
	ДопПараметры.Вставить("ОписаниеОповещенияОВыбореПериода", 
		"Поступление_ФормаСписка_УстановленОтборПериод"); 
...
Процедура УдалитьОтборы()
	...
	// Удалим отбор, не отображаемый на форме.
	Если КонтекстноеОткрытие = Истина Тогда	
		
		МассивПолейОтборов = Новый Массив;
		МассивПолейОтборов.Добавить("Ссылка");
		ДопПараметры.Вставить("МассивПолейОтборов", МассивПолейОтборов);
