...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ИзменениеПоказателейОборудования_ФормаСписка_УстановленОтборПериод" Тогда
...
Процедура ПредставлениеПериодаНажатие(Элемент, СтандартнаяОбработка)
	...
	ДопПараметры.Вставить("ОписаниеОповещенияОВыбореПериода", 
		"ИзменениеПоказателейОборудования_ФормаСписка_УстановленОтборПериод"); 
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	КлючеваяОперация = "ДокументИзменениеПоказателейОборудования (открытие)";
