...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	Если ТекущиеДанные.Свойство("Статья") Тогда
		ОтоборазитьРешенияНаСервере(ТекущиеДанные);	
	КонецЕсли;
...
&НаСервере
Процедура ОтоборазитьРешенияНаСервере(ТекущиеДанные)
	
	РаботаСОтборамиКлиентСервер.УстановитьЭлементОтбораСписка(Решения, 
		"Владелец", ТекущиеДанные.Статья);
