...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "УстановкаЗначенийМетрик_ФормаСписка_УстановленОтборПериод" Тогда	
...
&НаКлиенте
Процедура ОтборМетрикаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	СтандартнаяОбработка	= Ложь;
	УстановитьОтборСписка("Метрика", Элемент.Родитель.Имя, ВыбранноеЗначение);
	ВыбранноеЗначение		= Неопределено;
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	КлючеваяОперация = "ДокументУстановкаЗначенийМетрик (открытие)";
...
Процедура ПредставлениеПериодаНажатие(Элемент, СтандартнаяОбработка)
	...
	ДопПараметры.Вставить("ОписаниеОповещенияОВыбореПериода", 
		"УстановкаЗначенийМетрик_ФормаСписка_УстановленОтборПериод"); 
