...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Инвентаризация_ФормаСписка_УстановленОтборПериод" Тогда	
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	КлючеваяОперация = "ДокументИнвентаризация (открытие)";
...
Процедура ПредставлениеПериодаНажатие(Элемент, СтандартнаяОбработка)
	...
	ДопПараметры.Вставить("ОписаниеОповещенияОВыбореПериода", 
		"Инвентаризация_ФормаСписка_УстановленОтборПериод"); 	
