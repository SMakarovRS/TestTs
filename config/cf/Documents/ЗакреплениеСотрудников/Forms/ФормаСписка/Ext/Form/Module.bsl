...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ЗакреплениеСотрудников_ФормаСписка_УстановленОтборПериод" Тогда	
...
Процедура ПредставлениеПериодаНажатие(Элемент, СтандартнаяОбработка)
	...
	ДопПараметры.Вставить("ОписаниеОповещенияОВыбореПериода", 
		"ЗакреплениеСотрудников_ФормаСписка_УстановленОтборПериод"); 
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	КлючеваяОперация = "ДокументЗакреплениеСотрудников (открытие)";
