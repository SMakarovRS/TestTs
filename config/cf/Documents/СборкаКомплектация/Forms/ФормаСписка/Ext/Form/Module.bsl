...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "СборкаКомплектация_ФормаСписка_УстановленОтборПериод" Тогда	
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	КлючеваяОперация = "ДокументСборкаКомплектации (открытие)";
...
Процедура ПредставлениеПериодаНажатие(Элемент, СтандартнаяОбработка)
	...
	ДопПараметры.Вставить("ОписаниеОповещенияОВыбореПериода", 
		"СборкаКомплектация_ФормаСписка_УстановленОтборПериод"); 
