...
Функция КодировкаФайла(ПрисоединенныйФайл, Расширение = "") Экспорт
    ...
    //<< УИТ АдминистраторДом - 14.04.2020 12:32:37
    // Для файлов с картинками нет смысла возвращать кодировку.
	Если НЕ ПустаяСтрока(Расширение) И УправлениеITОтделом8УФ.ЭтоКартинка(Расширение) Тогда
		Возврат "";
	КонецЕсли;    
    //>>
