...
////////////////////////////////////////////////////////////////////////////////
// Работа с базой знаний на клиенте.
//  
////////////////////////////////////////////////////////////////////////////////
...
Функция ПолучитьТекстСтраницы(Знач ДанныеСсылки) Экспорт
	...
	ОсноваСтраницы = БазаЗнанийHTMLКлиентСервер.ПолучитьОсновуСтраницы(
		...
		?(ДанныеСсылки.Свойство("СтатьяБазыЗнанийСсылка"), ДанныеСсылки.СтатьяБазыЗнанийСсылка, ПредопределенноеЗначение("Справочник.СтатьиБазыЗнаний.ПустаяСсылка")));
