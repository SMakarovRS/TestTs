...
Процедура ПриОпределенииОбъектовСКомандамиЗаполнения(Объекты) Экспорт
	...
	//<< УИТ
	Объекты.Добавить(Метаданные.Документы.Доверенность);
	...
	Объекты.Добавить(Метаданные.Документы.ЗакреплениеСотрудников);
	Объекты.Добавить(Метаданные.Документы.ИзменениеПоказателейОборудования);
	Объекты.Добавить(Метаданные.Документы.Инвентаризация);
	Объекты.Добавить(Метаданные.Документы.ЛистУчетаРабочегоВремени);
	Объекты.Добавить(Метаданные.Документы.НарядНаРаботы);
	Объекты.Добавить(Метаданные.Документы.НачалоОбслуживания);
    Объекты.Добавить(Метаданные.Документы.ОкончаниеОбслуживания);
	Объекты.Добавить(Метаданные.Документы.Перемещение);
	Объекты.Добавить(Метаданные.Документы.ПеремещениеСотрудников);
	Объекты.Добавить(Метаданные.Документы.ПланированиеБюджета);
	Объекты.Добавить(Метаданные.Документы.Поступление);
	Объекты.Добавить(Метаданные.Документы.ПраваДоступаКИнформационнымРесурсам);
	Объекты.Добавить(Метаданные.Документы.Продажа);
	Объекты.Добавить(Метаданные.Документы.РазбиениеКомплектации);
	Объекты.Добавить(Метаданные.Документы.СборкаКомплектация);
	Объекты.Добавить(Метаданные.Документы.СнятиеЗакрепленияСотрудников);
	Объекты.Добавить(Метаданные.Документы.СоглашениеSLA);
	Объекты.Добавить(Метаданные.Документы.Списание);
	Объекты.Добавить(Метаданные.Документы.УчетДенежныхСредств);
	Объекты.Добавить(Метаданные.Документы.Проблема);
	Объекты.Добавить(Метаданные.Справочники.Контрагенты);
	Объекты.Добавить(Метаданные.ЖурналыДокументов.ОтветственныеСотрудники);
	Объекты.Добавить(Метаданные.ЖурналыДокументов.РемонтИОбслуживание);
	Объекты.Добавить(Метаданные.ЖурналыДокументов.СкладскиеДокументы);
	Объекты.Добавить(Метаданные.Документы.ПричиныОтклоненияОтГрафика);
	//>>
