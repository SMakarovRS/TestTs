...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.Задание);
	СписокОбъектов.Добавить(Документы.ЗаказКлиента);
	СписокОбъектов.Добавить(Документы.ЗаказПоставщику);
	СписокОбъектов.Добавить(Документы.ЗакреплениеСотрудников);
	СписокОбъектов.Добавить(Документы.ИзменениеПоказателейОборудования);
	СписокОбъектов.Добавить(Документы.Инвентаризация);
	СписокОбъектов.Добавить(Документы.КорректировкаРегистров);
	СписокОбъектов.Добавить(Документы.ЛистУчетаРабочегоВремени);
	СписокОбъектов.Добавить(Документы.НарядНаРаботы);
	СписокОбъектов.Добавить(Документы.НачалоОбслуживания);
	СписокОбъектов.Добавить(Документы.ОкончаниеОбслуживания);
	СписокОбъектов.Добавить(Документы.Перемещение);
	СписокОбъектов.Добавить(Документы.ПеремещениеСотрудников);
	СписокОбъектов.Добавить(Документы.ПланированиеБюджета);
	СписокОбъектов.Добавить(Документы.Поступление);
	СписокОбъектов.Добавить(Документы.ПраваДоступаКИнформационнымРесурсам);
	СписокОбъектов.Добавить(Документы.ПричиныОтклоненияОтГрафика);
	СписокОбъектов.Добавить(Документы.Проблема);
	СписокОбъектов.Добавить(Документы.Продажа);
	СписокОбъектов.Добавить(Документы.РазбиениеКомплектации);
	СписокОбъектов.Добавить(Документы.СборкаКомплектация);
	СписокОбъектов.Добавить(Документы.СнятиеЗакрепленияСотрудников);
	СписокОбъектов.Добавить(Документы.СоглашениеSLA);
	СписокОбъектов.Добавить(Документы.Списание);
	СписокОбъектов.Добавить(Документы.УчетДенежныхСредств);	
	СписокОбъектов.Добавить(Справочники.Банки);
	СписокОбъектов.Добавить(Справочники.Бюджеты);
	СписокОбъектов.Добавить(Справочники.ДоговорыКонтрагентов);
	СписокОбъектов.Добавить(Справочники.КарточкиНоменклатуры);
	СписокОбъектов.Добавить(Справочники.МестаХранения);
	СписокОбъектов.Добавить(Справочники.Комиссии);
	СписокОбъектов.Добавить(Справочники.Местоположения);
