...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	//<< УИТ
	УправлениеITОтделом8УФ.ПараметрыРаботыКлиентаПриЗапуске(Параметры);	
	//>>	
...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Итог) Экспорт
	...
	//<< УИТ Думенко Игорь - 21.02.2020 17:28:55
	// 3.1.4.3
	ОбщегоНазначения.ДобавитьПереименование(Итог, "3.1.4.3",
		"Роль.ДобавлениеИзменениеПаролейСотрудников", "Роль.ДобавлениеИзменениеПаролей");
	
	ОбщегоНазначения.ДобавитьПереименование(Итог, "3.1.4.3",
		"Роль.ЧтениеПаролейСотрудников", "Роль.ЧтениеПаролей");
	
	ОбщегоНазначения.ДобавитьПереименование(Итог, "3.1.4.3",
		"Подсистема.ЗаказыПоставщикам", "Подсистема.ЗакупкиИПродажи");
	
	ОбщегоНазначения.ДобавитьПереименование(Итог, "3.1.4.3",
		"Подсистема.ЗаказыПоставщикам.Подсистема.Потребности", "Подсистема.ЗакупкиИПродажи.Подсистема.Потребности");
	//>>	
