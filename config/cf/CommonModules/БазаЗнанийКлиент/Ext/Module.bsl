...
Функция ОбработатьРезультатПолнотекстовогоПоиска(Текст1С, МассивЭлементов) Экспорт
	...
	НачалоСтраницы	= СтрНайти(НРегТекст1С, "<body>");
	КонецСтраницы	= СтрНайти(НРегТекст1С, "</body>");
...
//	КонецЕсли;
//	
//	МассивПроверки = ОбщегоНазначенияКлиент.СкопироватьРекурсивно(МассивЭлементов);
//	
...
//			Если СтрНайти(ТекстПроверки, ТекстПоиска) > 0 Тогда
