...
Процедура НастройкаИнтерфейса(НастройкиРаботыИнтерфейса) Экспорт
	...
	//<< УИТ
	УправлениеITОтделом8УФДатыЗапретаИзменения.НастройкаИнтерфейса(НастройкиРаботыИнтерфейса);
	//>>		
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	//<< УИТ	
	УправлениеITОтделом8УФДатыЗапретаИзменения.ПриЗаполненииРазделовДатЗапретаИзменения(Разделы);	
	//>>		
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	//<< УИТ
	УправлениеITОтделом8УФДатыЗапретаИзменения.ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных);
	//>>	
