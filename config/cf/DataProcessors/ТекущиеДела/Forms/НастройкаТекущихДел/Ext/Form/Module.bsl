...
Процедура ЗаполнитьДеревоДел(НастройкиОтображения)
	...
	Если СтарыеНастройкиОтображения = Неопределено
		...
		Или Не СтарыеНастройкиОтображения.Свойство("ДеревоДел") 
		//<< УИТ
		Или СтарыеНастройкиОтображения.ДеревоДел.Колонки.Найти("ВыводитьВОповещениях") = Неопределено 
		Или СтарыеНастройкиОтображения.ДеревоДел.Колонки.Найти("Картинка") = Неопределено Тогда
		//>>
