...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//>> УИТ	
	Если Параметры.Свойство("ТолькоФайлы") Тогда
		
		уитТолькоФайлы = Истина;
		
		Попытка
		
			ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор,
				"Ссылка.ИДФайлаЭлектронногоПисьма", "", ВидСравненияКомпоновкиДанных.Равно,, уитТолькоФайлы, 
				РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный);
			
		 	Элемент = ЭтаФорма.Элементы.Добавить("ОтборТолькоФайлы", Тип("ПолеФормы"), ЭтаФорма); 
		    Элемент.Вид = ВидПоляФормы.ПолеФлажка; 
			Элемент.ПутьКДанным = "уитТолькоФайлы";		
			Элемент.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Нет;
			Элемент.ВидФлажка = ВидФлажка.Тумблер;
			Элемент.ФорматРедактирования = "БЛ='Вложения с картинками описания'; БИ='Только вложения'";
		    Элемент.УстановитьДействие("ПриИзменении", "уитТолькоФайлыПриИзменении");
...
Процедура СписокПеретаскивание(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка, Строка, Поле)
	...
	Если ТипЗнч(ПараметрыПеретаскивания.Значение) = Тип("Массив")
		...
		//<< УИТ Думенко Игорь - 16.03.2020 12:24:05
		...
		Если ВозможностьСоздаватьГруппыФайлов
			...
			Возврат;
		КонецЕсли;
		//<< УИТ Думенко Игорь - 16.03.2020 12:24:47
		КонецЕсли;
		//>>
		СтандартнаяОбработка = Ложь;
...
//<< УИТ Добавить в конец.
&НаКлиенте
Процедура уитТолькоФайлыПриИзменении(Элемент)
