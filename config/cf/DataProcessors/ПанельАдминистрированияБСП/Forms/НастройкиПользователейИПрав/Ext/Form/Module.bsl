...
//<< УИТ Добавлены включение/отключение групп доступа.
...
Процедура ОграничиватьДоступНаУровнеЗаписейПриИзмененииЗавершение(Ответ, Элемент) Экспорт
	...
	Если Не НаборКонстант.ОграничиватьДоступНаУровнеЗаписей Тогда
		...
		Если НаборКонстант.ИспользоватьГруппыДоступаМестХранения Тогда
			НаборКонстант.ИспользоватьГруппыДоступаМестХранения = Ложь;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ИспользоватьГруппыДоступаМестХранения);
		КонецЕсли;
		
		Если НаборКонстант.ИспользоватьГруппыДоступаКатегорийБазыЗнаний Тогда
			НаборКонстант.ИспользоватьГруппыДоступаКатегорийБазыЗнаний = Ложь;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ИспользоватьГруппыДоступаКатегорийБазыЗнаний);
		КонецЕсли;
		//>>
	КонецЕсли;
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ОграничиватьДоступНаУровнеЗаписей" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ИспользоватьГруппыДоступаКонтрагентов.Доступность    		  = ЕстьДоступность;
		Элементы.СправочникГруппыДоступаКонтрагентовОткрытьСписок.Доступность = ЕстьДоступность;
		
		Элементы.ИспользоватьГруппыДоступаМестХранения.Доступность    		  = ЕстьДоступность;
		Элементы.СправочникГруппыДоступаМестХраненияОткрытьСписок.Доступность = ЕстьДоступность;
		
		Элементы.ИспользоватьГруппыДоступаКатегорийБазыЗнаний.Доступность	  = ЕстьДоступность;
		Элементы.СправочникГруппыДоступаКатегорийБазыЗнанийОткрытьСписок.Доступность = ЕстьДоступность;
	КонецЕсли;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьГруппыДоступаМестХранения" ИЛИ РеквизитПутьКДанным = "" Тогда
		Элементы.СправочникГруппыДоступаМестХраненияОткрытьСписок.Доступность = НаборКонстант.ИспользоватьГруппыДоступаМестХранения;
	КонецЕсли;
	
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьГруппыДоступаКатегорийБазыЗнаний" ИЛИ РеквизитПутьКДанным = "" Тогда
		Элементы.СправочникГруппыДоступаКатегорийБазыЗнанийОткрытьСписок.Доступность = НаборКонстант.ИспользоватьГруппыДоступаКатегорийБазыЗнаний;
	КонецЕсли;
	//>>
