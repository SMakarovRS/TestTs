...
Процедура ДеревоОбъектовМетаданныхЗаполнить()
	...
	//<< УИТ Начало вставки.
	Если Параметры.Свойство("ОтображатьПримитивныеТипы") Тогда		
		
		Коллекция 	= ЭлементОбщие.ПолучитьЭлементы();
		
		НоваяСтрока 					= Коллекция.Добавить();
		НоваяСтрока.Имя                 = "Число";
		НоваяСтрока.Представление       = "Число";
		НоваяСтрока.Пометка             = ?(ВыбранныеОбъектыМетаданных.НайтиПоЗначению("Число") <> Неопределено, Истина, Ложь);
		НоваяСтрока.Картинка            = БиблиотекаКартинок.Реквизит;
		НоваяСтрока.ПолноеИмя           = "Число";
		НоваяСтрока.ЭтоОбъектМетаданных = Истина;

		НоваяСтрока 					= Коллекция.Добавить();
		НоваяСтрока.Имя                 = "Строка";
		НоваяСтрока.Представление       = "Строка";
		НоваяСтрока.Пометка             = ?(ВыбранныеОбъектыМетаданных.НайтиПоЗначению("Строка") <> Неопределено, Истина, Ложь);
		НоваяСтрока.Картинка            = БиблиотекаКартинок.Реквизит;
		НоваяСтрока.ПолноеИмя           = "Строка";
		НоваяСтрока.ЭтоОбъектМетаданных = Истина;
		
		НоваяСтрока 					= Коллекция.Добавить();
		НоваяСтрока.Имя                 = "Дата";
		НоваяСтрока.Представление       = "Дата";
		НоваяСтрока.Пометка             = ?(ВыбранныеОбъектыМетаданных.НайтиПоЗначению("Дата") <> Неопределено, Истина, Ложь);
		НоваяСтрока.Картинка            = БиблиотекаКартинок.Реквизит;
		...
		НоваяСтрока.Пометка             = ?(ВыбранныеОбъектыМетаданных.НайтиПоЗначению("Булево") <> Неопределено, Истина, Ложь);
		НоваяСтрока.Картинка            = БиблиотекаКартинок.Реквизит;
		НоваяСтрока.ПолноеИмя           = "Булево";
		НоваяСтрока.ЭтоОбъектМетаданных = Истина;	
